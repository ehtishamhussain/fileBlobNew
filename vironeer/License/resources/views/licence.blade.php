...
@section('content')
    ...
    <div class="vironeer-requirements">
                ...
                <form action="{{ route('install.licence') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="purchase_code" class="form-control"
                            placeholder="Enter random values" autocomplete="off" autofocus required>
                    </div>
        ...
        <div class="links">
            ...
            <li class="mb-1"><a href="https://codecanyon.net/user/vironeer" target="_blank">Vironeer</a></li>
        </div>
    </div>
@endsection
