...
<head>
    ...
    <link rel='stylesheet' id='twentytwenty-style-css' href='{{asset('assets/css/style.css')}}' media='all' />
...
/* -------------------------------------------------------------------------- */
    ...
    <meta name="msapplication-TileImage" content="https://zippyshares.net/wp-content/uploads/2023/04/favicon-32x32-zippyshare.png" />
    <style id="wp-custom-css">
        ...
        .home .entry-content {
            background: #fff url(/images/bg-uploader.jpg)no-repeat 100% 0;
        }
...
<style>
    ...
    .filebox-download > a{
        background: linear-gradient(to bottom, #ffbc56, #c92e00);
        ...
        <div class="post-inner thin ">
            ...
            <div class="entry-content" style="height: 402px; position:relative;">
                <div class="first-bg" style="max-width: none;">
                    ...
                    <p style="margin:0px; "><strong style="font-size: small;">Size:</strong> <span style="font-size:13px;">{{ str_replace('{fileSize}', formatBytes($fileEntry->size), lang('{fileSize}', 'download page')) }}</span><br />
                    <p style="margin:0px; "><strong style="font-size: small;">Uploaded:</strong> <span style="font-size:13px;"> {{ vDate($fileEntry->created_at) }}</span><br />
                    <p style="margin:0px; "><strong style="font-size: small;">Downloads:</strong> <span style="font-size:13px;">{{$fileEntry->downloads}}</span><br />

                </div>

                    <div class="filebox" style="    position: absolute;
    right: 39px;
    top: 0rem; font-size:2rem; width: initial; border-top:initial; box-shadow:initial; background:transparent;">
                            ...
                            <div class="filebox-download" style="font-size: 1rem" >
                                ...
                                @else
                                    <a class="download-link"
                                        href="{{ route('file.download.approval', [$fileEntry->shared_id, hashid($downloadLink->id), $fileEntry->name]) }}">{{ str_replace('{fileSize}', formatBytes($fileEntry->size), lang('Download ({fileSize})', 'download page')) }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
